  ...
  return (
    <div ref={targetRef} className={cn("relative z-0 h-[1200px]", className)}>
      <div className="sticky top-0 pt-8 mx-auto flex w-full flex-col items-center bg-transparent">
        <SplitLayout>
          <p className="max-w-3xl flex flex-wrap p-5 text-xl font-bold text-black/20 dark:text-white/20 md:p-8 md:text-xl lg:p-10 lg:text-heading-lg lg:leading-10">
            {words.map((word, i) => {
