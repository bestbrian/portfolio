            ...
            badge.tooltip ? (
              <Tooltip key={i}>
                <TooltipTrigger>
                  <Badge
                    className={cn(
                      "select-none px-3 py-2 rounded-lg bg-secondary text-primary border-primary font-normal text-sm hover:bg-secondary hover:text-primary",
                      badge.highlight
              ...
              <Badge
                ...
                className={cn(
                  "select-none px-4 py-2 rounded-lg bg-secondary text-primary border-primary font-normal text-sm hover:bg-secondary hover:text-primary",
                  badge.highlight
                    ? `bg-${badge.highlight} border-${badge.highlight} hover:bg-${badge.highlight} hover:border-${badge.highlight}`
                    : null
                )}
